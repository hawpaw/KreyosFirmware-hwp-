...
extern uint8_t date_format_process(uint8_t event, uint16_t lparam, void* rparam);
...
// the const strings
extern const char * const week_shortnameUS[];
extern const char * const week_shortnameEU[];
extern const char * const fontconfig_name[];
extern const char * const date_format_short[];
